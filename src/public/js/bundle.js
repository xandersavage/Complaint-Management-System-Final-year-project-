...
},{"axios":"../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createcomplaint.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createNewComplaint = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var createNewComplaint = exports.createNewComplaint = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, priority, title, description) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.status === 201) {
            (0, _alerts.showAlert)("success", "Complaint created successfully!");
            window.setTimeout(function () {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)("error", "Error creating complaint. Try again");
        case 11:
        case "end":
          return _context.stop();
      }
  ...
  return function createNewComplaint(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var createNewUser = exports.createNewUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, age, email, password, college, department) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
  ...
  return function createNewUser(_x, _x2, _x3, _x4, _x5, _x6) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"adminlogin.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.status === 200) {
            (0, _alerts.showAlert)("success", "Logged in successfully!!");
            window.setTimeout(function () {
              location.assign("/unresolved-complaints");
              // console.log("browser");
            }, 1500);
          }
          //console.log(res);
...
//   }
// };
},{"axios":"../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"resolvecomplaint.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resolveComplaint = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var resolveComplaint = exports.resolveComplaint = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(complaintId, remark) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.status === 200) {
            (0, _alerts.showAlert)("success", "Complained Resolved!");
            window.setTimeout(function () {
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)("error", "Unable to resolve complaint. Contact Support");
        case 10:
        case "end":
          return _context.stop();
      }
  ...
  return function resolveComplaint(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateprofile.js":[function(require,module,exports) {
"use strict";
...
var updateProfile = exports.updateProfile = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, age, college, department) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)("error", "Error Updating. Try again later");
        case 10:
        case "end":
          return _context.stop();
      }
...
var _createcomplaint = require("./createcomplaint");
var _createuser = require("./createuser");
var _adminlogin = require("./adminlogin");
var _resolvecomplaint = require("./resolvecomplaint");
...
var resolveComplaintForm = document.getElementById("updatecomplaint");
var updateUserForm = document.getElementById("updateUserForm");
var adminLogout = document.getElementById("adminLogout");
if (resolveComplaintForm) resolveComplaintForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var complaintId = document.getElementById("complaintId").innerText;
  var complaintRemark = document.getElementById("complaintRemark").value;
  (0, _resolvecomplaint.resolveComplaint)(complaintId, complaintRemark);
});
if (adminLoginForm) adminLoginForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var adminEmail = document.getElementById("adminemail").value;
  var adminPassword = document.getElementById("adminpassword").value;
  (0, _adminlogin.adminLogin)(adminEmail, adminPassword);
});
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    (0, _createuser.createNewUser)(name, age, email, password, college, department);
  });
}
...
if (adminLogout) adminLogout.addEventListener("click", _login.logout);
if (complaintForm) {
  complaintForm.addEventListener("submit", function (e) {
    ...
    var description = document.getElementById("complaindetails").value;
    (0, _createcomplaint.createNewComplaint)(type, priority, title, description);
  });
}
if (updateUserForm) {
  updateUserForm.addEventListener("submit", function (e) {
    ...
    var userCollege = document.getElementById("updateCollege").value;
    var userDepartment = document.getElementById("updateDepartment").value;
    var updateEmail = document.getElementById("updateEmail").value;
    var updateAge = document.getElementById("updateAge").value;
    (0, _updateprofile.updateProfile)(updateName, updateEmail, updateAge, userCollege, userDepartment);
  });
}
},{"./login":"login.js","./createcomplaint":"createcomplaint.js","./createuser":"createuser.js","./adminlogin":"adminlogin.js","./resolvecomplaint":"resolvecomplaint.js","./updateprofile":"updateprofile.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
